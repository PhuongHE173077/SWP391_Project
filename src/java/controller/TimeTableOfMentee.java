 ...
 * @author TUF F15
 */
@WebServlet(name="TimeTableOfMentee", urlPatterns={"/TimeTableOfMentee"})
public class TimeTableOfMentee extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TimeTableOfMentee</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TimeTableOfMentee at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (schedules == null) {
            ...
            List<ScheduleRequest>listsche = srd.getScheduleRequestsOfMentee(week.getId(), m.getId());
            ...
            request.getRequestDispatcher("TimeTableOfMentee.jsp").forward(request, response);
        } else {
