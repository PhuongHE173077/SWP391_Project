 ...
 * @author Admin
 */
@WebServlet(name = "HandlePaymentResponseController", urlPatterns = {"/handle-payment-response"})
public class HandlePaymentResponseController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HandlePaymentResponseController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HandlePaymentResponseController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
