<%-- 
    Document   : listMentee
    Created on : Jun 20, 2024, 9:24:12 PM
    Author     : Admin
--%>
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <form action="search-mentee" method="post" class="form-inline my-2 my-lg-0">
                            <div class="input-group input-group-sm">
                                <input name="txt" type="text" class="form-control" placeholder="Search for mentees...">
