...
<div class="container rounded bg-white mt-5 mb-5 p-4 shadow-sm">
    <h3 style="font-family: arial">Import Your CV:</h3>
            ...
            <div class="col-md-4 text-center">
                <div class="profile-picture-container">
                    <img id="profile-picture" class="img-account-profile rounded-circle mb-2"
                         src="${mentor.picture}?${System.currentTimeMillis()}"
                         alt="Profile Picture"
                    ...
                    <input type="file" id="file-input" name="profilePicture" style="display: none;" accept="image/*" onchange="loadFile(event)" required>
                </div>
            </div>
            <div class="col-md-8">
                    ...
                    <div class="tab-pane active">
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="date" id="dob" name="dob" placeholder="yyyy-mm-dd" required>
                            </div>
                            <div class="mb-3">
                                <label for="email">Email</label>
                                <input class="form-control" type="email" id="email" name="email" placeholder="user@example.com" required>
                            </div>
                            <div class="mb-3">
                                 <label>Gender</label><br>
                                    <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="gender" id="genderMale" value="1" required>
                                    <label class="form-check-label" for="genderMale">Male</label>
                            </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="2" required>
        <label class="form-check-label" for="genderFemale">Female</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="profession" name="profession" placeholder="Profession" required>
                            </div>
                            <div class="mb-3">
                                <label for="professionIntroduction">Profession Introduction</label>
                                <textarea class="form-control" id="professionIntroduction" name="profession_introduction" rows="4" placeholder="Introduce your profession" required></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="achievement" name="achievement" rows="4" placeholder="Describe your achievements" required></textarea>
                            </div>
                        </div>
                    </div>
