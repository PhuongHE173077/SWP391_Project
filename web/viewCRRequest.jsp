<%-- 
    Document   : viewCRRequest
    Created on : Jun 9, 2024, 9:10:19 PM
    Author     : Dell
--%>
...
<html>
    <head>
        ...
        <title>View Create request</title>
                                                    ...
                                                    <form class="form" novalidate="">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <p class="form-control"> ${request.subject} </p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <p class="form-control"> ${request.deadlineday} </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>Day Study</label>
                                                                            <p class="form-control"> ${request.day_number} </p>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <div class="form-group">
                                                                            <label>Content</label>
                                                                            <p class="form-control" rows="5">${request.content}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col d-flex justify-content-end">
                                                                <button class="btn btn-primary" type="submit">Book request</button>
                                                            </div>
                                                        </div>
                                                    </form>
