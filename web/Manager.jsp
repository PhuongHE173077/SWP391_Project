                                        ...
                                        <td>
                                            ...
                                            <c:choose>
                                                <c:when test="${item.status == 'Processing'}">
                                                    <button class="action-button approve-button" onclick="confirmAction('approve', '${item.id}')">Approve</button>
                                                    <button class="action-button reject-button" onclick="confirmAction('reject', '${item.id}')">Reject</button>
                                                </c:when>
                                                <c:otherwise>
                                                    <!-- Handle other status cases, you can leave this empty or add alternative content -->
                                                </c:otherwise>
                                            </c:choose>
                                            <button class="action-button see-detail-button" onclick="location.href = 'detailcontroller?id=${item.id}'">See Details</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
