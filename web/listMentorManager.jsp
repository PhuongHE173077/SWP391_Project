<%-- 
    Document   : listMentor
    Created on : Jun 20, 2024, 9:24:29 PM
    Author     : Admin
--%>
            ...
            <div class="row">
                ...
                <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar">
                    <div class="position-sticky">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="listmentor">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">List of Mentor</h1>.
                        <form action="searchmentor" method="post" class="form-inline my-2 my-lg-0">
                            <div class="input-group input-group-sm">
                                <input name="txtS" type="text" class="form-control" placeholder="Search for mentors...">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                <c:forEach var="item" items="${listmentor}">
                                    <tr>
                                        <td>${item.id}</td>
                                        <td>${item.name}</td>
                                        <td>${item.email}</td>
                    ...
                    <div class="pagination">
                        <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                            <a class="${i==page?"active":""}" href="listmentor?page=${i}">${i}</a>
                        </c:forEach>
                    </div>
                </main>
            </div>
