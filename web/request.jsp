...
<head>
    ...
    function updateCheckboxCount() {
        ...
        var mentorPrice = ${mentor.price}; // Mentor's price per day
        var totalPrice = count * mentorPrice; // Calculate total price

        document.getElementById('checkboxCount').innerText = 'Total Price: ' + totalPrice + ' 000VND';
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        updateCheckboxCount(); // Initial count update
    });
</script>
