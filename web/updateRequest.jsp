<%-- 
    ...
    Created on : Jun 9, 2024, 6:49:50 PM
    Author     : Dell
--%>
                ...
                <div class="col-12 col-lg-auto mb-3" style="width: 200px;">
                    <div class="card p-3">
                        <div class="e-navlist e-navlist--active-bg">
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link px-2 " ><i class=""></i><span><p class="btn btn-primary" > ${request.status}</p></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input value="${request.subject}" name="subject" class="form-control" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input value="${request.deadlineday}" type="date" name="deadlineDate" class="form-control" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col">
                                                                        <div class="form-group">
                                                                            <label>Day Study</label>
                                                                            <input value="${request.day_number}" type="number" name="dayNumber" class="form-control" required>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <div class="form-group">
                                                                            <label>Content</label>
                                                                            <input value="${request.content}" name="content" class="form-control" rows="5" required></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
